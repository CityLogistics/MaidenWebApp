  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4 text-[#202224] font-bold",
        caption: "flex justify-center pt-1 relative items-center",
        caption_label: "text-sm font-medium",
        nav: "space-x-1 flex items-center",
        nav_button: cn(
          buttonVariants({ variant: "outline" }),
          "h-8 w-8 bg-transparent p-0 opacity-100 hover:opacity-100 border-none rounded-[10px]"
        ),
        nav_button_previous: "absolute right-10 rounded-[10px]",
        nav_button_next: "absolute right-1",
        table: "w-full border-collapse space-y-1",
        head_row: "flex",
        head_cell:
          "rounded-md w-9 font-normal text-[0.8rem] text-[#202224] mx-1",
      ...
      components={{
        IconLeft: () => (
          <ChevronLeft
            size={30}
            className=" bg-slate-100 p-1 text-[#121212] text-lg font-bold"
          />
        ),
        IconRight: () => (
          <ChevronRight
